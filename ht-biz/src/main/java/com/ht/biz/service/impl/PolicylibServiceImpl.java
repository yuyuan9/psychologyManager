...
import com.ht.biz.mapper.PolicylibMapper;
...
public class PolicylibServiceImpl extends ServiceImpl<PolicylibMapper, Policylib> implements PolicylibService{
	...
	private static final String keyword1=" (projecname:*%s* OR specialmum:*%s* OR managerway:*%s* OR supportobj:*%s* OR applyterm:*%s*) ";//电脑端搜索
	private static final String keyword2=" (projecname:*%s* OR specialmum:*%s*) ";//小程序搜索
	private static final String keyword3=" (projecname:*%s* OR applyterm:*%s*) ";//手机端搜索
