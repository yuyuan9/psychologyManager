...
var box = new Vue({
    ...
    methods: {
        ...
        //访问记录
        visitData: function () {
            htajax.get('/ht-biz/poliprorecord/list?local=' + '立项库',
                function (data) {
                    if (data.code == 10000) {
        ...
        //查询点击状态
        getCode: function () {
            htajax.get('/ht-biz/castbox/userbox?code=' + 'projectlib_current', function (data) {
                if (data.code == 10000) {
                    box.flag = true;
                    box.getContent(0);
                } else {
        ...
        getContent: function (type, index) {
            ...
            htajax.postFormDone('/ht-biz/projectlib/list?t=' + new Date().getTime(), {
                keyword: keyword,
                // yearProject:issueData,
                year1: issueData,
                year2: issueData1,
                name: '',
                special: '',
                ...
                if (box.pageturn != '') {//翻页记录
                    if (box.flag) {//是否点击弹框
                        if (data.code == 10000) {
                            ...
                            box.outKeyword = box.getUrlData("keyword2");
                            box.honeyInfo = false;
                        } else {
        ...
        deriveToData: function () {
            htajax.get('/ht-biz/poliproexport/getcounts?local=' + '立项库',
                function (data) {
                    if (data.code == 10000) {
        ...
        //导出
        deriveTo: function () {
            var keyword = this.url2;
            var urlId2 = this.getUrlData("keyword2");
            if (keyword == '' || keyword == undefined) { keyword = urlId2; }
            this.words = keyword;
        ...
        // unfold:function(e){
        //     if (e.currentTarget.parentElement.previousElementSibling.getAttribute("class") == 'list_content_text list_content_3text list_content_3texts') {
        //         e.currentTarget.parentElement.previousElementSibling.classList.add('list_content_3texts_show');
        //         e.srcElement.innerHTML = "收起";
        //     } else {
        //         e.currentTarget.parentElement.previousElementSibling.classList.remove('list_content_3texts_show');
        //         e.srcElement.innerHTML = "查看详情";
        //     }
        // },
        //查看详情
        lookmore: function (id,name) {
            ...
            htajax.get('/ht-biz/projectlib/edit?id=' + id, function (data) {
                if (data.code == 10000) {
