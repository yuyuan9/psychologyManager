    ...
    methods: {
        ...
        getHeadCity: function (mycity1,mycity2) {
            ...
            if (mycity1 != "" && mycity2 == "") {//省级不为空
                if (mycity1 == "全国") {
                    ...
                    library.province = mycity1;
                    library.city = '市级';
                    library.area = '区级';
                    library.pitchDataRegion = mycity1;
                    library.isRegion = 2;
                    library.pitchCity = '';
                    library.pitchArea = '';
                }
                ...
                library.province = mycity1;
                library.city = mycity2;
                library.area = '区级';
                library.pitchDataRegion = mycity1;
                library.isRegion = 2;
                library.isCityActive = 1;
                library.pitchCity = mycity2;
                library.pitchArea = '';
            }
            this.isclaCation = '';
            this.targetData = '';
        ...
        getRegion: function (index,type) {
            ...
            htajax.get(encodeURI(url + "&t="+new Date().getTime()), function (data) {
                if (data.code = 10000) {
                    if (data.data == '') { that.notfind = 1; }
                    if (data.data != '') {that.notfind = 0;}
                    //console.log(data);
                    layer.closeAll();
