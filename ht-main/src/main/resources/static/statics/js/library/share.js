...
//        console.log(settings);
        var $msb_main = "<a class='msb_main' style='display:none;'></a>";
        var $social_group = "<div class='social_group'>" +
            "<a class='msb_network_button weixin'>weixin</a>" +
            "<a class='msb_network_button QQ'>QQ</a>" +
    ...
    function QQ(target, options) {
        ...
        OPenWindow(replaceAPI(qq, options));
...
//        console.log((bodyW - elW) / 2);
    ...
    var qq='http://connect.qq.com/widget/shareqq/index.html?url={url}&title={title}';
