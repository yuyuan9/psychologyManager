...
var box = new Vue({
    ...
    methods: {
        ...
        firstgetproductlist:function(){
            var producttypeone = this.getUrlData("producttypeone");
            var productTypetwo = this.getUrlData("productTypetwo");
            var productTypethere = this.getUrlData("productTypethere");
            this.one = producttypeone;
            this.two = productTypetwo;
            if (productTypetwo != '') { var targetId = productTypetwo;} 
            htajax.postForm("/ht-biz/product/findchild", {
                id: targetId,
            }, function (data) {
                if (data.code == 10000) {
                    box.productList3 = data.data;
                    var timer=setTimeout(function(){
                        $(".title_nav2>span").removeClass("active");
                        $("#" + productTypethere).addClass("active");
                    },100);
                    box.getproductResult(1,producttypeone, productTypetwo, productTypethere);
                }
            }, function (data) {
                //layer.msg(data.msg);
            })
        ...
        getproductlist: function (event){
            ...
            this.twoName = event.toElement.innerText;
            this.two = targetId;
            htajax.postForm("/ht-biz/product/findchild", {
                id: targetId,
            }, function (data) {
        ...
        getThreeId:function(id,name){
            this.three = id;
            this.threeName = name;
            $(".title_nav2>span").removeClass("active");
            $("#" + id).addClass("active");
        },
        getproductResult: function (index, producttypeone, productTypetwo, productTypethere){
            var cur = index;
            var one = this.one;
            var two = this.two;
            if (this.three == ''){
                this.three = productTypethere;
            }
